...
from PyQt5.QtWidgets import QMainWindow, QStatusBar, qApp
...
from ui.MT1DControlWidget import MT1DControlWidget
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.mtd_control = MT1DControlWidget(self, self.tree)

        self.inversion_type = InversionTypeWidget([self.inversion_1d_control])

        self.ui.tabWidget.addTab(self.mtd_control, 'MT1D')
    ...
    def open_files(self):
        ...
        if file_paths is None:
            self.show_statusbar_msg('Файлы не выбраны', 2000)
            qApp.processEvents()
            return

        self.show_statusbar_msg('Импорт файлов')
        qApp.processEvents()
        ...
        self.show_statusbar_msg('Импорт завершен', 2000)
        qApp.processEvents()
    ...
    def show_statusbar_msg(self, msg: str = None, time: int = 0):
